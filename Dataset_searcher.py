...
class Dataset_searcher(object):
	def __init__(self, data_set_name):
		...
		self.room_id_df = self.read_in_target_csv(csv_name='room_id_nick_name_chart.csv')
		self.interpretation_man_df = self.read_in_target_csv(csv_name='man_id_nick_name_chart.csv')
